...
interface CreatorDetailsEndpoint {
    ...
    suspend fun getCreatorComics(@Path("creatorId") creatorId: Int): DataWrapper<Comic>

    @GET("/v1/public/creators/{creatorId}/events")
    suspend fun getCreatorEvents(@Path("creatorId") creatorId: Int): DataWrapper<Event>

    @GET("/v1/public/creators/{creatorId}/series")
    suspend fun getCreatorSeries(@Path("creatorId") creatorId: Int): DataWrapper<Series>

    @GET("/v1/public/creators/{creatorId}/stories")
    suspend fun getCreatorStories(@Path("creatorId") creatorId: Int): DataWrapper<Story>
}