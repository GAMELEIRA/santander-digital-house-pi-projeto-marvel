...
interface SeriesDetailsEndpoint {
    ...
    suspend fun getSeriesCharacters(@Path("seriesId") seriesId: Int): DataWrapper<Character>

    @GET("/v1/public/series/{seriesId}/comics")
    suspend fun getSeriesComics(@Path("seriesId") seriesId: Int): DataWrapper<Comic>

    @GET("/v1/public/series/{seriesId}/creators")
    suspend fun getSeriesCreators(@Path("seriesId") seriesId: Int): DataWrapper<Creator>

    @GET("/v1/public/series/{seriesId}/events")
    suspend fun getSeriesEvents(@Path("seriesId") seriesId: Int): DataWrapper<Event>

    @GET("/v1/public/series/{seriesId}/stories")
    suspend fun getSeriesStories(@Path("seriesId") seriesId: Int): DataWrapper<Story>
}